...
# CPU-bound: performance is limited by CPU computation time (math, encoding, image processing).
# I/O-bound: performance is limited by waiting for input/output (network, disk, database).
# Rule of thumb: use multiprocessing for CPU-bound work; use threads/async for I/O-bound work.
